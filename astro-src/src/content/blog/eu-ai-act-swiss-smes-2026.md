---
title: "The EU AI Act Countdown: What Swiss SMEs Must Know Before August 2026"
description: "With 168 days until the August 2, 2026 deadline, Swiss SMEs exporting to the EU face critical compliance requirements under the EU AI Act. Learn what qualifies as high-risk AI, documentation requirements, and how to prepare now."
pubDate: 2026-02-16
...
According to the [Swiss Federal Customs Administration's 2025 trade statistics](https://www.ezv.admin.ch/), the European Union accounts for approximately **52% of Switzerland's total export volume**—representing more than CHF 170 billion in annual trade. For many Swiss SMEs, this dependency runs even deeper:
...
1. **Does the system operate in any of the Annex III application areas listed above?**
2. **Could the system's output significantly impact fundamental rights, health, safety, or access to essential services?**
3. **Does a human decision-maker rely on the AI system's output when making consequential decisions about individuals?**
...
Document potential harms the system could cause (false positives, false negatives, biased outputs, etc.), assess their likelihood and severity, implement mitigations (confidence thresholds, human review, etc.), and continuously monitor real-world performance against risk assumptions.
...
**Practical Implementation:**
For a recruitment AI: Document the demographic composition of training data, test for gender/age/nationality biases, implement balancing techniques if biases are detected, validate that the system performs equivalently across demographic groups, and maintain records of all data quality checks.
...
**Key Requirements:**
The technical documentation must contain, at minimum:
...
**Practical Implementation:**
Create a living technical documentation package that evolves with your AI system. Template structures are available from various EU AI Act compliance consulting firms and will likely be standardized as the regulation matures. The documentation must be sufficiently detailed that a competent third party could understand the system's functioning and compliance measures without requiring access to proprietary source code.
...
**Tier 1: Violations of Prohibited AI Practices**
...
**Tier 2: Violations of High-Risk AI System Requirements**
...
**Tier 3: Supply of Incorrect, Incomplete, or Misleading Information**
Up to **€7.5 million** or **1.5% of total worldwide annual turnover** (whichever is higher)
